...
const KEYS: string[] = [
  ...
  'core:home.muteOn',
  'core:home.muteOff',
  'core:home.changeLanguage',
  'core:home.switchTitle',
  'core:home.switchBody',
  'core:settings.title',
  ...
  'core:settings.tabs.general',
  'core:settings.tabs.journey',
  'core:settings.sound',
  'core:settings.haptics',
  'core:settings.gate.title',
  'core:settings.gate.wrong',
  // letter-land
  'letter-land:loading',
  ...
  // animal-safari
  'animal-safari:meta.name',
  'animal-safari:meta.description',
  'animal-safari:loading',
  'animal-safari:hearName.listen',
  'animal-safari:hearName.tapAgain',
  'animal-safari:hearName.which',
  'animal-safari:whichSound.listen',
  'animal-safari:whichSound.tapAgain',
  'animal-safari:whichSound.which',
  'animal-safari:a11y.replay',
  'animal-safari:a11y.replaySound',
  'animal-safari:a11y.choiceTile',
  'animal-safari:a11y.choiceTileGeneric',
  'animal-safari:levelSolved.title',
  'animal-safari:levelSolved.next',
  'animal-safari:levelSolved.finish',
  // animal-safari animal names (keyed by animal id)
  'animal-safari:names.lion',
  'animal-safari:names.elephant',
  'animal-safari:names.cow',
  'animal-safari:names.dog',
  'animal-safari:names.cat',
  'animal-safari:names.frog',
  'animal-safari:names.horse',
  'animal-safari:names.sheep',
  'animal-safari:names.rooster',
  'animal-safari:names.duck',
  'animal-safari:names.bird',
  'animal-safari:names.bee',
  // numbers-land
