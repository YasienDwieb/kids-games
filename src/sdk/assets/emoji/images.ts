 ...
 * filenames use the glyph's codepoints (uppercase hex, hyphen-joined, FE0F stripped).
 *
 * To add glyphs: drop the PNG in ./png/<CODE>.png and add a line here.
...
export const EMOJI_IMAGES: Record<string, ImageSourcePropType> = {
  ...
  "🕷️": require("./png/1F577.png"),
  "🕸️": require("./png/1F578.png"),
  "🏔️": require("./png/1F3D4.png"),
